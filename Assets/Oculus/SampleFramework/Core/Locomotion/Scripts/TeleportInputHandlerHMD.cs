...
public class TeleportInputHandlerHMD : TeleportInputHandler
{
    ...
    /// <summary>
    ///     The button used to trigger the teleport after aiming. It can be the same button as the AimButton, however you
    ///     cannot
    ...
    /// <summary>
    ///     When true, the system will not use the PreTeleport intention which will allow a teleport to occur on a button
    ///     downpress.
    ///     When false, the button downpress will trigger the PreTeleport intention and the Teleport intention when the button
    ///     is released.
    /// </summary>
