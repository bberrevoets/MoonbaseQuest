...
/// <summary>
///     This orientation handler will aim the player at the point they aim the HMD at after they choose the teleport
///     location.
/// </summary>
public class TeleportOrientationHandlerHMD : TeleportOrientationHandler
{
    ...
    protected override void UpdateTeleportDestination()
    {
        ...
        if (AimData.Destination.HasValue && (UpdateOrientationDuringAim || LocomotionTeleport.CurrentState == LocomotionTeleport.States.PreTeleport))
        {
            ...
            float d;
            var   hit = plane.Raycast(new Ray(t.position, t.forward), out d);
            if (hit)
            {
