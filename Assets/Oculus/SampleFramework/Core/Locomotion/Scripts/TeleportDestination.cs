...
///     additional OVRTeleportDestinations to allow targeting to occur before the previous destination finishes it’s
///     animation.
/// </summary>
public class TeleportDestination : MonoBehaviour
{
    ...
    [Tooltip(
            "After the player teleports, the character controller will have it's rotation set to this value. It is different from the OrientationIndicator transform.rotation in order to support both head-relative and forward-facing teleport modes (See TeleportOrientationHandlerThumbstick.cs).")]
    ...
    /// <summary>
    ///     If anything is handling the Deactivated event, then the handlers will be responsible for recycling the object when
    ///     it is finished.
    /// </summary>
