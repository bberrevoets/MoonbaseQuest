...
/// <summary>
///     This component is responsible for moving the character capsule to match the HMD, fading out the camera or blocking
///     movement when
...
public class CharacterCameraConstraint : MonoBehaviour
{
    ...
    /// <summary>
    ///     This should be set to 1 to make the screen completely fade out when the HMD is inside world geometry. Lesser values
    ...
    /// <summary>
    ///     This value is used to control how far from the character capsule the HMD must be before the fade to black is
    ///     complete.
    ///     This should be tuned so that it is fully faded in before the camera will clip geometry that the player should not
    ///     be able see beyond.
    /// </summary>
    ...
    private void CameraUpdate()
    {
        ...
        {
            var camHeight = Mathf.Min(CameraRig.centerEyeAnchor.transform.localPosition.y, PreferredHeight);
            var newHeight = camHeight;
            ...
            else
            {
                ...
                // necessary elevation. 
                var        rayStart = _character.transform.position;
                RaycastHit info;
                var        rayEnd = rayStart;
            ...
            var newCamPos = CameraRig.transform.localPosition;
