...
{
    /// <summary>
    ///     When checking line of sight to the destination, add this value to the vertical offset for targeting collision
    ///     checks.
    /// </summary>
    ...
    protected override bool ConsiderTeleport(Vector3 start, ref Vector3 end)
    {
        ...
        var tp = AimData.TargetHitInfo.collider.gameObject.GetComponent<TeleportPoint>();
        if (tp == null)
        {
            return false;
        }
