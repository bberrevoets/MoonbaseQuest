...
public abstract class TeleportInputHandler : TeleportSupport
{
    ...
    /// <summary>
    ///     One of the core functions of the TeleportInputHandler is to notify the LocomotionTeleport of the current intentions
    ///     of the
    ///     user with respect to aiming, teleporting, and abandoning a pending teleport.
    ///     Derivations of this class will check buttons or whatever inputs they require to return values indicating what the
    ///     user is
    ///     trying to do.
    /// </summary>
    /// <returns></returns>
