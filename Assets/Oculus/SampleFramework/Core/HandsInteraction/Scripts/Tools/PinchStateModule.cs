...
namespace OculusSampleFramework
{
    ...
    public class PinchStateModule
    {
        ...
        /// </summary>
        public bool PinchUpAndDownOnFocusedObject => _currPinchState == PinchState.PinchUp && _firstFocusedInteractable != null;

        public bool PinchSteadyOnFocusedObject => _currPinchState == PinchState.PinchStay && _firstFocusedInteractable != null;

        public bool PinchDownOnFocusedObject => _currPinchState == PinchState.PinchDown && _firstFocusedInteractable != null;

        public void UpdateState(OVRHand hand, Interactable currFocusedInteractable)
        {
            var pinchStrength = hand.GetFingerPinchStrength(OVRHand.HandFinger.Index);
            var isPinching    = Mathf.Abs(PINCH_STRENGTH_THRESHOLD - pinchStrength) < Mathf.Epsilon;
