...
namespace OculusSampleFramework
{
    ...
    public class TrainButtonVisualController : MonoBehaviour
    {
        ...
        private void ActionOrInContactZoneStayEvent(ColliderZoneArgs collisionArgs)
        {
            ...
            var buttonScale         = _buttonContactTransform.localScale;
            var interactionPosition = collisionArgs.CollidingTool.InteractionPosition;
            var localSpacePosition = _buttonContactTransform.InverseTransformPoint(
                    interactionPosition);
            ...
            var offsetVector = localSpacePosition - LOCAL_SIZE_HALVED * Vector3.one;
            // affect offset by button scale. only care about y (since y goes inwards)
            var scaledLocalSpaceOffset = offsetVector.y * buttonScale.y;
