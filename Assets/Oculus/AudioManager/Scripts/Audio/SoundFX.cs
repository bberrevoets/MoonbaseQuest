...
namespace OVR
{
    ...
    */
    ...
    public class SoundFX
    {
        ...
        public AnimationCurve volumeFalloffCurve = new AnimationCurve(new Keyframe(0f, 1.0f), new Keyframe(1f, 1f));
        ...
        public AnimationCurve reverbZoneMix = new AnimationCurve(new Keyframe(0f, 1.0f), new Keyframe(1f, 1f));
        ...
        public SoundFX()
        {
            ...
            volumeFalloffCurve = new AnimationCurve(new Keyframe(0f, 1.0f), new Keyframe(1f, 1f));
            reverbZoneMix      = new AnimationCurve(new Keyframe(0f, 1.0f), new Keyframe(1f, 1f));
            spread             = 0.0f;
        ...
        public float GroupVolumeOverride   => (soundGroup != null) ? soundGroup.volumeOverride : 1.0f;
        ...
        */
        public AudioClip GetClip()
        {
            ...
            if (playback == SoundFXNext.Random)
            {
                ...
                var idx = Random.Range(0, soundClips.Length);
                while (idx == lastIdx)
                {
        ...
        */
        ...
        -----------------------
        */
        public float GetPitch() => Random.Range(pitchVariance.x, pitchVariance.y);
