...
public sealed class ONSPPropagationMaterial : MonoBehaviour
{
    ...
    public void UploadMaterial()
    {
        ...
        foreach (var p in absorption.points)
        {
        ...
        foreach (var p in transmission.points)
        {
        ...
        foreach (var p in scattering.points)
        {
    ...
    private static void SoundProof(ref ONSPPropagationMaterial material)
    {
        ...
        material.scattering.points   = new List<Point> {new Point(1000f)};
        material.transmission.points = new List<Point>();
    }
    ...
    public sealed class Point
    {
        ...
        public static implicit operator Point(Vector2 v) => new Point(v.x, v.y);

        public static implicit operator Vector2(Point point) => new Vector2(point.frequency, point.data);
    }
    ...
    public sealed class Spectrum
    {
        ...
        public float this[float f]
        {
            get
            {
                if (points.Count > 0)
                {
                    var lower = new Point(float.MinValue);
                    var upper = new Point(float.MaxValue);
