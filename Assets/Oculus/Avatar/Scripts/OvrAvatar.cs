...
public class OvrAvatar : MonoBehaviour
{
    ...
    public static IntPtr GetRenderPart(ovrAvatarComponent component, uint renderPartIndex) => Marshal.ReadIntPtr(component.renderParts, Marshal.SizeOf(typeof(IntPtr)) * (int) renderPartIndex);

    private static string GetRenderPartName(ovrAvatarComponent component, uint renderPartIndex) => component.name + "_renderPart_" + (int) renderPartIndex;
    ...
    private void Start()
    {
        ...
        AvatarLogger.Log(AvatarLogger.Tab + "LOD: " + LevelOfDetail);
