...
)
{
	...
	#endif
	if (sampleMode == SAMPLE_MODE_RSRM)
	{
...
)
{
	...
	if (maskType == MASK_TYPE_REFLECTION)
	{
...
#define MASK_INPUTS IN, tangentTransform, surfaceNormal
	...
	#else
	c.a = _Alpha * c.a * tex2D(_AlphaMask, TRANSFORM_TEX(uv, _AlphaMask)).r * IN.vertColor.a * ComputeMask(
		MASK_INPUTS, _BaseMaskType, _BaseMaskParameters, _BaseMaskAxis);
	#endif
